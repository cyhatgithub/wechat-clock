 ...
 */
public class PlatformBaseMessage {
    ...
    public int getFuncFlag() { return FuncFlag; }
    public void setFuncFlag(int funcFlag) { FuncFlag = funcFlag; }

    public PlatformBaseMessage() {}

    public PlatformBaseMessage(String toUserName, String fromUserName, long createTime, String msgType, int funcFlag) {
